...
namespace SRPSimulator.PropertiesControl
{
    ...
    public partial class PropertiesPanel : UserControl
    {
        ...
        private void SRPProperties_PropertyValueChanged(object s, PropertyValueChangedEventArgs e)
        {
            ...
            if (SRPProperties.SelectedObject.GetType() == typeof(RodConfigEmbedded))
            {
        ...
        {
            if (SRPProperties.SelectedObject.GetType() == typeof(PUnitConfigEmbedded))
            {
        ...
        {
            MathModel.PUnitConfigEmbedded.labelSizeA => Properties.Resource.UnitGeometryA as Bitmap,
            MathModel.PUnitConfigEmbedded.labelSizeC => Properties.Resource.UnitGeometryC as Bitmap,
            MathModel.PUnitConfigEmbedded.labelSizeG => Properties.Resource.UnitGeometryG as Bitmap,
            MathModel.PUnitConfigEmbedded.labelSizeH => Properties.Resource.UnitGeometryH as Bitmap,
            MathModel.PUnitConfigEmbedded.labelSizeI => Properties.Resource.UnitGeometryI as Bitmap,
            MathModel.PUnitConfigEmbedded.labelSizeK => Properties.Resource.UnitGeometryK as Bitmap,
            MathModel.PUnitConfigEmbedded.labelSizeP => Properties.Resource.UnitGeometryP as Bitmap,
            MathModel.PUnitConfigEmbedded.labelSizeR => Properties.Resource.UnitGeometryR as Bitmap,
